...
import mafoe.jpaperformance.repository.FamilieRepository3;
 ...
 * <p>
 * Dritter Ansatz: Nur ein SELECT, mit hoher FETCH SIZE.
 */
@Transactional
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = PersistenzConfig.class)
public class _3_Modellgruppen_mit_FamilienTest {

	@Autowired
	private FamilieRepository3 repo;
